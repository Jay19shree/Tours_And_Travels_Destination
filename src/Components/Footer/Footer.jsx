        ...
        <div className="container">
            <div className="row g-4">
                ...
                <div className="row g-3 w-100">
                    ...
                    <p><i className="fas fa-check me-2"></i>666 777 9999</p>
                     <p><i className="fas fa-check me-2"></i>jaish@gmail.com</p>
            ...
            <div className="row mt-5">
                <div className="col">
                    <div className="gooter-img d-flex flex-wrap justify-content-center gap-3">
