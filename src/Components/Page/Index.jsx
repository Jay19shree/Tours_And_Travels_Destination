          ...
          <div className="hero hero1 d-flex flex-column justify-content-center align-items-center">
            <div className="hero-content w-100 d-flex flex-column justify-content-center align-items-center">
              ...
              <button className="btn text-white hero-btn mt-5">
                LEARN MORE
                <img src={btnArrow} className="img-fluid" alt="" />
              </button>
            </div>
          </div>
        </SwiperSlide>
      ...
      <div className="about py-5">
        <div className="container">
          ...
          <div className="flex-column d-flex align-items-start justify-content-start gap-3">
            ...
            <p>
              Embark on a transformative journey as our company invites you to experience the world, creating unforgettable memories through exceptional travel adventures.
            </p>
          </div>
          </div>
          ...
          <div className="about-bottom mt-5 d-flex gap-4">
            ...
            <div className="about-col-box d-flex align-items-center">
              ...
              <div className="ms-4 m-0 fs-5">5.2+ Satisfied Clients</div>
            </div>
          </div>
          <div className="col-lg-6 about-img">
            <img src={about1} className='img-fluid' alt=""/>
            <img src={abElement1} className="img-fluid abElement-1 position-absolute" alt=""/>
             <img src={abElement2} className="img-fluid abElement-1 position-absolute" alt=""/>
              <img src={abElement3} className="img-fluid abElement-1 position-absolute" alt=""/>
          </div>
        </div>
      </div>
      </div>
      ...
      <div className="discover py-5">
         <div className="section-title discover-title">
          <div className="text-center d-flex flex-column align-items-center justify-content-center gap-3">
            ...
            <p>
              Our clients rave about our exceptional the seamless experiences that exceeded their expectations.
            </p>
          </div>
        </div>
        <div className="row px-5 my-5 mx-0  align-items-center justify-content-center">
            ...
            <div className="col-lg-4 step-card rounded border p-4 d-flex flex-column gap-3">
              <div className="step-img rounded">
                ...
                <div className="step-content">
                  ...
                  <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eius sit nam culpa veritatis!</p>
                </div>
            </div>
            <div className="col-lg-4 step-card rounded border p-4 d-flex flex-column gap-3">
...
<div className="offer py-5 position-relative overflow-hidden">
  {/* subtle background shape / texture (decorative) */}
  <img src={offerBG1} className="offer-bg-decor position-absolute" alt="" />
  ...
  <div className="container">
    <div className="row align-items-center">
      ...
      <div className="col-lg-6">
        <div className="offers-wrapper">
          <div className="offer-content">
            <div className="offer-label d-inline-flex align-items-center gap-2 mb-3">
              <img src={plane} alt="" className="plane-icon" />
              <span>35% OFFER</span>
              <img src={plane} alt="" className="plane-icon" />
            </div>

            <h2 className="offer-title">Get Special Offer</h2>
            ...
            <div className="btn-box">
              <button className="btn custom-btn1 d-inline-flex align-items-center gap-2">
                Learn More
                <img src={btnArrow} className="btn-arrow" alt="" />
              </button>
            </div>
          </div>

          {/* big 40% OFF — absolutely positioned and responsive */}
      ...
      <div className="col-lg-6 text-end">
        <img src={offerBG2} alt="travel" className="offer-main-img img-fluid" />
      </div>
    </div>
  </div>
</div>
      ...
      <div className="testimonial py-5 position-relative">
        ...
        <div className="section-title test-title">
          ...
          <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Commodi corporis nulla ex voluptate optio similique deleniti dicta libero culpa odio.</p>
        </div>
      </div>
      </div>
              ...
              <div className="row align-items-center">
                <div className="col-lg-6">
                  <div className="testimonial-img d-flex align-items-center justify-content-center">
                    <img src={testimg01} alt="" className="img-fluid"/>
                  </div>
                </div>
                <div className="col-lg-6">
                  <div className="test-content">
                    ...
                    <p className="test-pare">
                         Lorem, ipsum dolor sit amet consectetur adipisicing elit. Minus sapiente odit sit. Animi velit iure nisi nobis adipisci libero id!
                    </p>
                    ...
                    <div className="test-user mt-3 d-flex align-items-center gap-2">
                      <img src={testimg02} alt="" className="img-fluid"/>
                    </div>
                    <div className="test-user-info">
                      <h3>TASHA STEWART</h3>
                      <p className="m-0">Web Developer at ThemeXviewr</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <div className="container py-5">
        <div className="row align-items-center">
          ...
          <div className="col-md-6">
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Itaque, nulla adipisci tenetur laudantium delectus aliquam. At facere officia magnam ea.</p>
          </div>
        </div>
              ...
              <div className="card-img-overlay d-flex flex-column justify-content-end blog-overlay">
                ...
                <div className="detail">
                  <h5 className="card-title fw-bold">Beach Days, Long Hikes, And </h5>
                    <p className="card-title">Emma Mark . April 25, 2025</p>
                </div>
              </div>
            </div>
          </div>
           <div className="col-lg-4 col-md-6">
            <div className="card blog-card border-0 overflow-hidden">
              ...
              <div className="card-img-overlay d-flex flex-column justify-content-end blog-overlay">
                <span>Read More</span>
                <div className="detail">
                  <h5 className="card-title fw-bold">Island Hoppingand Weather Tips</h5>
                    <p className="card-title">Emma Mark . April 25, 2025</p>
                </div>
              </div>
            </div>
    ...
    <div className="col-12 col-md-8">
      ...
      <div className="row footer-head align-items-center px-3 px-md-5 py-4">
        <div className="col-12 col-md-6 mb-3 mb-md-0 footer-title section-title text-center text-md-start">
          <h2>Subscribe for latest update about Travelling
</h2>
      ...
      <div className="row px-3 px-md-5 py-4">
        <div className="col-12 col-md-6 mb-4">
          <a href="#" className="logo text-dark fw-bold d-block mb-2 navbar-brand">FrostQuest</a>

          <p className="text-muted">
            Go on a journey of unparalleled adventure with our travel agency, 
            where every detail is curated to perfection, ensuring unforgettable memories.
          </p>
        ...
        <div className="col-12 col-md-6">
          <div className="row text-center text-md-start mt-4 mt-md-5">
  ...
  <div className="footer-bottom container-fluid text-white bg-dark p-2 text-center">
    <div className="mb-0 small">
      © 2025 <strong>K2infocom</strong> – All Rights Reserved.
    </div>
  </div>
</div>
