...
function Contact() {
  return (
            ...
            <div className="row g-5">
                <div className="col-lg-6 contact-info d-flex flex-column justify-content-center">
                    ...
                    <div className="info-block d-flex">
                        ...
                        <div className="info-text">
                            <h5>Phone Number</h5>
                            <p className="mb-0">(488) 8542-389-5470</p>
                              <p>(488) 8542-389-5470</p>
                ...
                <div className="mb-3">
                <textarea className='form-control' rows="4" placeholder='Type ypur message...'></textarea>
    ...
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d241316.2289699221!2d72.71412525687607!3d19.08280670615086!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7c6306644edc1%3A0x5da4ed8f8d648c69!2sMumbai%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1762628477484!5m2!1sen!2sin"
    width="100%"
    height="500"
    style={{border:0}}
    allowFullScreen =""
