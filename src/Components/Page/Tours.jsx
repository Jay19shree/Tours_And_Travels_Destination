    ...
    <>
            ...
            <div className="col-lg-8 ps-4 ps-lg-5">
              <div className="row">
                <div className="col-lg-12 border rounded p-3 d-flex align-items-center justify-content-end gap-3">
                  ...
                  <i className="bi bi-grid-3x3-gap-fill tours-grid-icon fs-5"></i>
                </div>
              </div>
                  ...
                  <div className="col-lg-6 mb-4" key={Data.id}>
                    <div className="tour-card shadow-sm">
                      ...
                      <div className="tour-card-content mt-4 px-3">
                        <Link to={`/tour-details/${Data.id}`} className='text-black text-decoration-none'>
                          <h2>{Data.name}</h2>
                        </Link>
                        ...
                        <div className="tour-card-box border-top py-3 d-flex justify-content-between gap-2 mt-3">
                          ...
                          <Link to={`/tour-details/${Data.id}`}>View Details</Link>
                        </div>
      ...
      <div className="gallery-grid my-5 mb-0">
        <div className="row">
          ...
          >
            <SwiperSlide><div className="gallery-image"><img src={galleryimage1} className='img-fluid w-100' /></div></SwiperSlide>
            <SwiperSlide><div className="gallery-image"><img src={galleryimage2} className='img-fluid w-100' /></div></SwiperSlide>
            <SwiperSlide><div className="gallery-image"><img src={galleryimage3} className='img-fluid w-100' /></div></SwiperSlide>
            <SwiperSlide><div className="gallery-image"><img src={galleryimage4} className='img-fluid w-100' /></div></SwiperSlide>
            <SwiperSlide><div className="gallery-image"><img src={galleryimage5} className='img-fluid w-100' /></div></SwiperSlide>
          </Swiper>
        </div>
      </div>
