                    ...
                    <div className="top-destination-item w-100">
                        ...
                        <div className="top-destination-content">
                            <div className="dest-title-price position-relative d-flex justify-content-between align-items-center border-b">
                                <h3 className="dst-title fw-bolder fs-4 m-0">Rome, Italy</h3>
        ...
        <div className="container">
            <div className="row align-items-center">
                <div className="col-lg-6 mb-4 mb-lg-0">
                    <div className="section-title top-destination-title-title">
                        ...
                        <ul className='list-unstyled pt-4'>
                            <li className='d-flex align-items-center gap-3 pb-4'>
                                ...
                                <div>
                                    <h4>Best of Hotel</h4>
                                    <p>
                                        We don't just work without concrete and steel.<br/>
                        ...
                        <button className='btn customer-btn2'>
                ...
                <div className="col-lg-6">
                    <div className="row g-3">
                        <div className="col-sm-6 col-12 mb-3">
                          ...
                          <div className="col-sm-6 col-12 mb-3">
                            <div className="travel-experience-image travel-experience-image-mb position-relative rounded-3 overflow-hidden">
                                <img src={travelexperienceimage3} alt='Europe' className='img-fluid w-100'/>
            ...
            <div className="row align-items-center">
                <div className="col-lg-5 mb-4 mb-lg-0">
                     <div className="section-title travel-places-title">
                        ...
                        <h2>Travel Place for<br/>You & your<br/>Family</h2>
                        ...
                        <div className="travel-experience-btn mt-4">
                            ...
                            <p style={{fontWeight:"700", fontSize:"1.3rem"}}>500k+ Happy Customers</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row align-items-center gy-4">
                        ...
                        <div className="col-lg-6">
                            <div className="travel-places-info">
                                <h4>Waiting for Adventure? Don't miss them</h4>
                                <p>
                                    We don't just work with concrete and steel.
                                    We are Approachable, with even our highest concrete and steel. We work wth people
                                </p>
                                ...
                                <ul className="list-unstyled pt-3 travel-place-ul">
                                    <li className="pb-3">
                                        <i className="fa-solid fa-check me-2"></i>Generation Technology</li>
                                     <li className="pb-3">
                                        <i className="fa-solid fa-check me-2"></i>Generation Technology</li>
                                     <li className="pb-3">
                                        <i className="fa-solid fa-check me-2"></i>Audio Performance</li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
{/* business banner */}
    <div className="section business-banner my-5" style={{backgroundColor:'#f7ffc4'}}>
        <div className="container">
            <div className="row">
      ...
      <div className="col-lg-6 mb-5">
        <div className="section-title travel-places-title">
          ...
          <p className="py-3 text-start">
            We don't just work with concrete and steel.
            We are approachable, and even with our highest standards,
            we work with people to create meaningful experiences.
          </p>

          <button className="btn customer-btn-2">Find out more</button>
        </div>
      </div>
        ...
        >
          ...
          <SwiperSlide>
            <div className="ab-tst-item w-100">
              <img src={tst2} alt="testimonial" />

              <p className="fs-5 mb-5">
                We don't just work with concrete and steel.
                We are approachable and work with people to create great experiences.
              </p>
...
<section className="my-5 py-5">
    <div className="container">
            ...
            <div className="col-12">
                <div className="row g-4 justify-content-center">
                    <div className="col-lg-4">
                        <div className="card h-100 shadow-lg rounded-4 p-5 text-star border-0 price-card">
                            <h2><sup>$</sup>99<small>/month</small></h2>
                            <div className="d-flex justify-content-center my-4 w-100">
                                <img src={price1} alt='tour-1' className='object-fit-cover' width='70%' style={{borderRadius:"100px"}}/>
                                 <img src={price2} alt='tour-2' className='rounded-circle ms-2 object-fit-cover' width='30%'/>
                            </div>
                            <h4 className='fw-bold fs-1'>Turkey Tour</h4>
            ...
            we work with people to create meaningful experiences.
                            ...
                            <ul className="list-unstyled text-start card-price-list p-0">
                                <li className="fs-5 fw-bold mb-3">
                                    <i>Generation Technology</i>
                                </li>
                                 <li className="fs-5 fw-bold mb-3">
                                    <i>Audio Performance</i>
                                </li>
                                 <li className="fs-5 fw-bold mb-3">
                                    <i>Generation Technology</i>
                                </li>
                            ...
                            <button className="btn customer-btn-2 w-100">
                    ...
                    <div className="col-lg-4">
                        <div className="card h-100 shadow-lg rounded-4 p-5 text-star border-0 price-card">
                            ...
                            <div className="d-flex justify-content-center my-4 w-100">
                                <img src={price3} alt='tour-1' className='object-fit-cover' width='70%' style={{borderRadius:"100px"}}/>
                                 <img src={price4} alt='tour-2' className=' rounded-circle ms-2 object-fit-cover' width='30%'/>
                            </div>
                            <h4 className='fw-bold fs-1'>Full Travel</h4>
                            <p className='text-muted fs-5'>
                                     We don't just work with concrete and steel.
            We are approachable, and even with our highest standards,
            we work with people to create meaningful experiences.
                    ...
                    <div className="col-lg-4">
                        <div className="card h-100 shadow-lg rounded-4 p-5 text-star border-0 price-card">
                            ...
                            <div className="d-flex justify-content-center my-4 w-100">
                                <img src={price3} alt='tour-1' className='object-fit-cover' width='70%' style={{borderRadius:"100px"}}/>
                                  <img src={price6} alt='tour-2' className='rounded-circle ms-2 object-fit-cover' width='30%'/>
                            </div>
                            <h4 className='fw-bold fs-1'>World Tour</h4>
                            <p className='text-muted fs-5'>
                                     We don't just work with concrete and steel.
            We are approachable, and even with our highest standards,
            we work with people to create meaningful experiences.
        ...
        <p className='price-bottom-text text-center mt-5 fs-5'>
            ...
            <a href="#" className="text-decoration-none fw-bold">Click Here</a>
        </p>
    </div>
</section>
        ...
        className='gallery-swiper'>
            <SwiperSlide>
                <div className="gallery-image">
                    <img src={galleryimage1} alt='gallery' className='img-fluid w-100'/>
                </div>
            </SwiperSlide>
             <SwiperSlide>
                <div className="gallery-image">
